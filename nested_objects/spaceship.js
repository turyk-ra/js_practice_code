...
// Create a variable capFave and assign the captain‘s favorite food (the element in the 0th index of her 'favorite foods' array)
// to it. Make sure to use bracket and dot notation to get the value of the food through nested access 
...
spaceship.passengers = [{ name: 'John', degree: 'engineer' }];
