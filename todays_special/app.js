...
// Ниже the setters, use the get keyword to create a todaysSpecial method. Leave the function body empty for now.
...
let mealsAndPrices = [{ meal: 'Pizza', price: 10 }, { meal: 'Taco', price: 5 }, { meal: 'Burger', price: 7 }, { meal: 'Pasta', price: 12 }, { meal: 'Sushi', price: 15 }];
...
const randomIndex = Math.floor(Math.random() * mealsAndPrices.length);

menu.meal = mealsAndPrices[randomIndex].meal;
menu.price = mealsAndPrices[randomIndex].price;
console.log(menu);
